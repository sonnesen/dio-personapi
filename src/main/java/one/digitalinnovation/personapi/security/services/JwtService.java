...
public class JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts.builder()
                ...
                .setIssuedAt(Date.from(Instant.now(Clock.system(ZoneId.systemDefault()))))
                .setExpiration(Date.from(Instant.now(Clock.system(ZoneId.systemDefault()))
                        .plusMillis(expirationInMillis)))
